    ...
    return (
        <>
            ...
            <div className="phone">
                ...
                <p style={{ fontSize: "40px", color: "white", cursor: "pointer", textDecoration: "underline", caretColor: "transparent" }}>Hire Me</p>
